...
public class Demo_WaitNotify extends JFrame implements Runnable {
    ...
    public Demo_WaitNotify() {
        this.setTitle(TITLE);
        this.setSize(W, H);
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setIconImage(ImageUtils.createImage(ImageUtils.FLOWER_64PX, Demo_WaitNotify.class));
        conn.setLayout(null);
        initComponents();
        initEvent();
    }
    ...
    public static void main(String[] args) {
        // Runnable
        Demo_WaitNotify ex04 = new Demo_WaitNotify();
            ...
            synchronized (this) {
                while (suspended) {
                    try {
                        ...
                        Logger.getLogger(Demo_WaitNotify.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
