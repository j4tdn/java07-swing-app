...
public class FrStudentForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/editor.png"))); // NOI18N
        ...
        jMenu2.setText("Open Recent Project");

        jMenuItem6.setText("Lesson 17");
        jMenu2.add(jMenuItem6);

        jMenuItem7.setText("Lesson 18");
