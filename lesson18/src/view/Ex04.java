...
public class Ex04 extends JFrame {
    ...
    private void initComponents() {
        ...
        tfResult.setBounds(120 + 40 + getDWidth(btSubmit), getPreHeight(lbTitle) + getPreHeight(tfInput) + 30 * 3, (getPreWidth(lbTitle) - 40) / 2, 32);
        ...
        lbErrorMessage.setBounds(120, btSubmit.getY() + getPreHeight(btSubmit) + 30, getPreWidth(lbErrorMessage) + 10, getPreHeight(lbErrorMessage));
