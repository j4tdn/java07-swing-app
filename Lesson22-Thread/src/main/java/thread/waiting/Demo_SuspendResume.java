...
public class Demo_SuspendResume extends JFrame implements Runnable {
    ...
    public Demo_SuspendResume() {
        this.setTitle(TITLE);
        this.setSize(W, H);
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.setIconImage(ImageUtils.createImage(ImageUtils.FLOWER_64PX, Demo_SuspendResume.class));
        conn.setLayout(null);
        initComponents();
        initEvent();
    }
    ...
    private void btResumeEvent() {
        btResume.addMouseListener(new MouseAdapter() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btResume.setBackground(highlightButton);
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btResume.setBackground(Color.RED);
            }
    ...
    private void initComponents() {
        ...
        btResume.setBounds(250, 350, (int) p3.getWidth()+30, (int) p3.getHeight());
        conn.add(btResume);
    ...
    public static void main(String[] args) {
        // Runnable
        Demo_SuspendResume ex04 = new Demo_SuspendResume();
